...
frappe.views.Workspace = class Workspace {
	...
	setup_actions(page) {
		...
		this.page.add_inner_button(__("Cash Flow Chart"), () => {
			window.location.href = "/cashflow"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Progress"), () => {
			window.location.href = "/app/progress"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Staff"), () => {
			window.location.href = "/app/staff-dashboard"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Labour"), () => {
			window.location.href = "/app/labour"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Active Tender"), () => {
			window.location.href = "/app/tender"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Rejected Tender"), () => {
			window.location.href = "/app/tender"
		}, __("Dashboard"));
		this.page.add_inner_button(__("Approved Tender"), () => {
			window.location.href = "/app/tender"
		}, __("Dashboard"));
